...
# GitHub Issues Auto-Creation Script (Python Generated)
# Generiert: 2025-09-03T16:10:56.686290
...
gh issue create \
  ...
  --label "roadmap","enhancement","priority-high" \
...
gh issue create \
  ...
  --label "roadmap","enhancement","priority-medium" \
...
echo "Creating issue 14/22: Konferenz-Management"
gh issue create \
  --title "Konferenz-Management" \
  --body-file "issue-014-konferenz-management.md" \
  --label "roadmap","enhancement","priority-low" \
  --assignee "@me" || echo "Failed to create issue: Konferenz-Management"

echo "Creating issue 15/22: Cloud-Synchronisation"
gh issue create \
...
echo "Creating issue 16/22: Talk-Bewertungen"
gh issue create \
...
echo "Creating issue 17/22: Conference-Management Portal"
gh issue create \
...
echo "Creating issue 18/22: Real-time Updates"
gh issue create \
...
echo "Creating issue 19/22: Dependency Injection"
gh issue create \
...
echo "Creating issue 20/22: Error Handling"
gh issue create \
...
echo "Creating issue 21/22: Code-Architektur"
gh issue create \
...
echo "Creating issue 22/22: Code-Analyse"
gh issue create \
  --title "Code-Analyse" \
